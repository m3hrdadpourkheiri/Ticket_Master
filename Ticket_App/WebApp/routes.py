...
from WebApp.forms import RegistrationForm,LoginForm,NewTicketForm,CommentForm,StatusForm,NewUserForm,UpdateProfileForm
...
def show_ticket(ticket_id):
    ...
    return render_template('ticket_details.html',ticket=ticket,c_form=c_form,s_form=s_form,comments=comments)
